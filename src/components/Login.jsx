...
export default function Login() {
 ...
 const signupClick = () =>{
  ...
  return (
    <div className='container-lg bg-black-special flex flex-col w-full min-h-screen overflow-x-hidden justify-center '>
      <h1 className='text-white flex justify-center text-5xl mb-20'>Log in.</h1>
      <div className='flex flex-col justify-center items-center'>
        <button className='w-80 h-10 rounded-lg bg-black-special text-white border border-white border-opacity-40  flex justify-center p-2'>
      ...
      <div className='flex mt-2 justify-center items-center'>
        ...
        <button className='text-white mr-1' onClick={signupClick}>Create Account</button>
